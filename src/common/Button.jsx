export const Button = ({text, onclick}) =>{
    return <button onClick={onclick} className="py-3 lg:px-5 px-5  text-white hover:opacity-85 rounded-2xl border-2 border-blue-400 bg-blue-400 font-semibold ">
        {text}
    </button>
}

export const ButtonOutline = ({text, onclick}) =>{
    return <button onClick={onclick} className="py-2 px-3 text-xs text-purple-950 hover:opacity-85 rounded-lg border border-purple-950  font-semibold">
        {text}
    </button>
}
